        ...
        <div>
          <Grid container spacing={1}>
            ...
            <div>
              ...
              <h4>OR</h4>
              JSON.parse(this.state.tags).result.tags[0].tag.en
              JSON.parse(this.state.tags).result.tags[0].confidence.toFixed(2)
            ...
            <Grid container item xs={12} sm={6}>
              <Paper className="paper-image">
                <Grid container spacing={2}>
                  <Grid item xs>
                  <Typography noWrap>Most Probably: {JSON.parse(this.state.tags).result.tags[0].tag.en} </Typography>
                    <Typography noWrap>Percentage Probability: {JSON.parse(this.state.tags).result.tags[0].confidence.toFixed(2)}%</Typography>
                  </Grid>
                </Grid>
              </Paper>
              ...
              <Paper className="paper-image">
                <Grid container spacing={2}>
                  <Grid item xs>
                    <Typography noWrap>May be: {JSON.parse(this.state.tags).result.tags[1].tag.en} </Typography>
                    <Typography noWrap>Percentage Probability: {JSON.parse(this.state.tags).result.tags[1].confidence.toFixed(2)}%</Typography>
                  </Grid>
                </Grid>
              </Paper>
              ...
              <Paper className="paper-image">
                <Grid container spacing={2}>
                  <Grid item xs>
                    <Typography noWrap>Can also be: {JSON.parse(this.state.tags).result.tags[1].tag.en} </Typography>
                    <Typography noWrap>Percentage Probability: {JSON.parse(this.state.tags).result.tags[1].confidence.toFixed(2)}%</Typography>
                  </Grid>
                </Grid>
              </Paper>
